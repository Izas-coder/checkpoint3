...
lista_hobbies = ["tenis", "música", "danza"]
primer_elemento = lista_hobbies[2]
print(primer_elemento) 
...
primera_mayuscula = frase[:1].upper()
frase = " Yo me llamo Lidia."
# Obtener la primera palabra (antes del primer espacio)
primera_palabra = frase.strip().split()[0]
# Convertir la primera palabra a mayúsculas
primera_mayuscula = primera_palabra.upper()
# Crear una nueva cadena con la primera palabra en mayúsculas y el resto de la frase
nueva_frase = primera_mayuscula + " " + frase[2:]  # Añades el espacio explícitamente
print(nueva_frase)
